...
class WalkaroundService {
  ...
  static Future<bool> submitForm(String query) async {
    //  Overseer over = new Overseer();
    print("-- AUTH SERVICE BROWSE METHOD 1.2");
    http.Response response;
    String _url = "";
    if (query != null && query.isNotEmpty) {       _url = 'https://emportal.etradeverse.com/api/walkArond?${query}';
      print("// final USER URL   hhh  >>>" + _url);
      response = await http.post(Uri.parse(_url), headers: {
        'Access-Control-Allow-Origin': '*',
        'Accept': 'application/json',
        'Content-type': 'application/json',
        'Authorization': 'Bearer 4|SG1ZdwFx1iIqyuuuYM1OiJoq510EvMTglw9RnQTM',
      });
